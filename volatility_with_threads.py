class TikVolatility:
    ...
    def _csv_handler(self, dirpath, file):
        csv_thread = CsvMultyThread(dirpath, file)
        csv_thread.start()
        csv_thread.join()
        self.tik_list.append(csv_thread.csv_result)
...
class CsvMultyThread(threading.Thread):

    def __init__(self, dirpath, file, *args, **kwargs):
    ...
    def run(self):
        ...
        self.csv_result = [csv_list[0][0], volatylity]
